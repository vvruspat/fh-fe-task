...
export const NumberInput = ({after, before, className, value, min = 0, max = Infinity, onNumberChange, ...inputProps}: Props) => {
    ...
    return <div className={cn('number-input-wrapper', className)}>
        <Input 
            before={<Button mode="secondary" className="number-input-button" onClick={onDecrement}><Icon name="minus" /></Button>}
            after={<Button mode="secondary" className="number-input-button" onClick={onIncrement}><Icon name="plus" /></Button>}
            type="number"
