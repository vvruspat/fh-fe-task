...
export const DateRangePicker = ({
  ...
  return (
    <div className={cn("date-picker", className)} {...divProps}>
      <button
        className="date-picker-button"
        onClick={() => setCheckInPickerShown(true)}
        type="button"
      >
        <Icon name="calendar" className="date-picker-button-icon" />
        {checkIn
          ? new Intl.DateTimeFormat("en-US").format(checkIn)
          : "Check-in"}
      </button>
      <div className="date-picker-spacer"></div>
      <button
        className="date-picker-button"
        onClick={() => setCheckOutPickerShown(true)}
        type="button"
      >
        {checkOut
          ? new Intl.DateTimeFormat("en-US").format(checkOut)
          : "Check-out"}
      </button>
